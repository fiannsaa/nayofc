...
reply(String(e))
        ...
        if (budy.includes("https://chat.whatsapp.com/")) {
        	if (!mek.key.fromMe){
				...
				reply('*LINK GROUP - DETECTED*\n\n\nSudah di bilangin jangan kirim link grup!!!\nMaaf aku akan kick kamu dari grup ini.\nBandel sih😝\nByeee ... byeee ... ')
...
pemuda.updatePresence(from, Presence.recording)
   ...
   const sotoy = [
     ...
     case "5b017c6ac1fb953c7bd21034d2fca5fad75ef2da4c3b2c2877ef49fa544e74bf":
        ...
        case 'menu':
        case 'help':
        ptod = "62895211144821@s.whatsapp.net"
        stod = `${sender}`
        uwu = '```'
...
- Hari : ${week} ${weton}
- Tanggal : ${calender}`
sendButLocation(from, `${menu}`, `${uwu}Naylabot - Ketik .command untuk Simpel Menu ${uwu}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}allmenu`,buttonText:{displayText:'MENU ALL📒'},type:1},{buttonId:`${prefix}owner`,buttonText:{displayText:'DEVELOPER👤'},type:1},{buttonId:`${prefix}sewabot`,buttonText:{displayText:'SEWABOT🤖'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
case 'allmenu':
        ptod = "62895211144821@s.whatsapp.net"
        stod = `${sender}`
...
└─────────────────⬣
${uwu}`
pemuda.sendMessage(from, menu, text, { quoted: ftrol, thumbnail: fs.readFileSync('./pemuda_1.jpg'), contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} - ${week} ${weton} - ${calender}`,body:"",mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtu.be/ax8Ju5CX-B8`}}})
break
case 'command':
 listMsg = {
 buttonText: 'LIST MENU',
 footerText: '*_©Naylabot*',
...
case 'sewabot': 
                    wew = fs.readFileSync(`./src/logobot.jpg`)
                      lzain = `⭕𝗝𝗔𝗦𝗔 𝗦𝗘𝗪𝗔 𝗕𝗢𝗧 𝗕𝗬 𝗡𝗔𝗬𝗟𝗔⭕

*ʾ˖ ≡ 𝗣𝗥𝗜𝗖𝗘 𝗟𝗜𝗦𝗧 𝗦𝗘𝗪𝗔 ָ࣪ ✦*

𖥻  ࣪ ᳝ 1 Minggu 𓂃 ࣪˖ 5K
𖥻  ࣪ ᳝ 1 Bulan 𓂃 ࣪˖ 10K
𖥻  ࣪ ᳝ Permanen 𓂃 ࣪˖ 15K
...
𝗚𝗥𝗨𝗣¹
chat.whatsapp.com/HtOZC9r432KJ5WFvoDfD41

𝗚𝗥𝗨𝗣²
chat.whatsapp.com/LXYmNwioMdZ686J5AyUS27

𝗚𝗥𝗨𝗣³
chat.whatsapp.com/KCnpE1co6L93ElUpaMaPfV

𝗡𝗢𝗧𝗘 : Gausah di chat jika masih tetap kere dan ga punya modal!!!
...
break
		...
		case 'sc':
		case 'sourcecode':
		pemuda.sendMessage(from, { text: "script ini masih Versi Beta dan akan terus Update :\nhttps://youtu.be/ax8Ju5CX-B8", matchedText: 'https://youtu.be/ax8Ju5CX-B8', description: "", title: "don't click here !!!", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
       case 'debug':
...
case 'x':
        ...
        if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
        pemuda.toggleDisappearingMessages(from, 0)
        sendButLocation(from, `${ngazap(prefix)}`, `${virtag(prefix)}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}bbaij72njnwjibdo16830nslm1782`,buttonText:{disText:'⚔️ Naylastore ⚔️'},type:1}])
        pemuda.toggleDisappearingMessages(from, 0)
break
case 'bugrow':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
